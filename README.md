...
Designed dashboards with real-time analytics, activity logs to track faculty updates, added features like search, filters, pagination, and modal-based editing for efficient workflows.
